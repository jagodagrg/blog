Blog is a flaks application that can be used as a personal blog. The user can draft, publish, edit posts and delete drafts. Only the user logged in as admin can perform these actions.
